...
def train(dataset):
    ...
    for row in dataset:
        ...
        for i in range(len(row) - 1):
            attribute_counts[i][row[i].strip("'").strip(), class_val] += 1  # strip single quotes and whitespaces
